...
import (
	...
	"github.com/daniiiiiiiiiiil/finance-microservices/admin-service/internal/core/auth/jwt"
	...
	usersclient "github.com/daniiiiiiiiiiil/finance-microservices/admin-service/internal/core/clients/users"
...
func main() {
	...
	logger.Debug("Initializing finance client")
	financeClient, err := financeClient.NewFinanceClient("finance:50053", cfg)
	if err != nil {
