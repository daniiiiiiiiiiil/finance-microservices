...
func (x *CreateProfileRequest) GetPasswordHash() string {
	if x != nil {
...
type MarkDeletingRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            int32                  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *MarkDeletingRequest) Reset() {
	*x = MarkDeletingRequest{}
	mi := &file_proto_users_users_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MarkDeletingRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MarkDeletingRequest) ProtoMessage() {}

func (x *MarkDeletingRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_users_users_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MarkDeletingRequest.ProtoReflect.Descriptor instead.
func (*MarkDeletingRequest) Descriptor() ([]byte, []int) {
	return file_proto_users_users_proto_rawDescGZIP(), []int{12}
}

func (x *MarkDeletingRequest) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
type FinalizeDeleteRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            int32                  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *FinalizeDeleteRequest) Reset() {
	*x = FinalizeDeleteRequest{}
	mi := &file_proto_users_users_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *FinalizeDeleteRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FinalizeDeleteRequest) ProtoMessage() {}

func (x *FinalizeDeleteRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_users_users_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FinalizeDeleteRequest.ProtoReflect.Descriptor instead.
func (*FinalizeDeleteRequest) Descriptor() ([]byte, []int) {
	return file_proto_users_users_proto_rawDescGZIP(), []int{13}
}

func (x *FinalizeDeleteRequest) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *RestoreUserRequest) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
const file_proto_users_users_proto_rawDesc = "" +
	...
	"\x04data\x18\x02 \x01(\v2\x14.users.PatchUserDataR\x04data\"\xde\x01\n" +
	...
	"\rPatchUserData\x12\x1b\n" +
	"\tfull_name\x18\x01 \x01(\tR\bfullName\x12!\n" +
	"\fphone_number\x18\x02 \x01(\tR\vphoneNumber\"\xac\x01\n" +
	...
	"\rpassword_hash\x18\x05 \x01(\tR\fpasswordHash\"@\n" +
	...
	"\x13MarkDeletingRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\"'\n" +
	"\x15FinalizeDeleteRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\"$\n" +
	"\x12RestoreUserRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id2\xa9\t\n" +
	"\vUserService\x12P\n" +
	...
	"\vAdminExists\x12\x16.google.protobuf.Empty\x1a\x1a.users.AdminExistsResponse\"\"\x82\xd3\xe4\x93\x02\x1c\x12\x1a/api/v1/users/admin-exists\x12o\n" +
	"\fMarkDeleting\x12\x1a.users.MarkDeletingRequest\x1a\x16.google.protobuf.Empty\"+\x82\xd3\xe4\x93\x02%:\x01*\" /api/v1/users/{id}/mark-deleting\x12u\n" +
	"\x0eFinalizeDelete\x12\x1c.users.FinalizeDeleteRequest\x1a\x16.google.protobuf.Empty\"-\x82\xd3\xe4\x93\x02':\x01*\"\"/api/v1/users/{id}/finalize-delete\x12g\n" +
	"\vRestoreUser\x12\x19.users.RestoreUserRequest\x1a\x16.google.protobuf.Empty\"%\x82\xd3\xe4\x93\x02\x1f:\x01*\"\x1a/api/v1/users/{id}/restoreB\tZ\a./usersb\x06proto3"
...
var file_proto_users_users_proto_goTypes = []any{
	...
	(*MarkDeletingRequest)(nil),   // 12: users.MarkDeletingRequest
	(*FinalizeDeleteRequest)(nil), // 13: users.FinalizeDeleteRequest
	(*RestoreUserRequest)(nil),    // 14: users.RestoreUserRequest
...
var file_proto_users_users_proto_depIdxs = []int32{
	...
	15, // 8: users.UserService.GetMetrics:input_type -> google.protobuf.Empty
	10, // 9: users.UserService.GetUserByEmail:input_type -> users.GetUserByEmailRequest
	15, // 10: users.UserService.AdminExists:input_type -> google.protobuf.Empty
	12, // 11: users.UserService.MarkDeleting:input_type -> users.MarkDeletingRequest
	13, // 12: users.UserService.FinalizeDelete:input_type -> users.FinalizeDeleteRequest
	14, // 13: users.UserService.RestoreUser:input_type -> users.RestoreUserRequest
	3,  // 14: users.UserService.GetUser:output_type -> users.UserResponse
	3,  // 15: users.UserService.PatchUser:output_type -> users.UserResponse
	15, // 16: users.UserService.DeleteUser:output_type -> google.protobuf.Empty
	3,  // 17: users.UserService.CreateProfile:output_type -> users.UserResponse
	7,  // 18: users.UserService.ListUsers:output_type -> users.ListUsersResponse
	3,  // 19: users.UserService.UpdateRole:output_type -> users.UserResponse
	9,  // 20: users.UserService.GetMetrics:output_type -> users.MetricsResponse
	3,  // 21: users.UserService.GetUserByEmail:output_type -> users.UserResponse
	11, // 22: users.UserService.AdminExists:output_type -> users.AdminExistsResponse
	15, // 23: users.UserService.MarkDeleting:output_type -> google.protobuf.Empty
	15, // 24: users.UserService.FinalizeDelete:output_type -> google.protobuf.Empty
	15, // 25: users.UserService.RestoreUser:output_type -> google.protobuf.Empty
