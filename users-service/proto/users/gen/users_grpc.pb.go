...
const (
	...
	UserService_MarkDeleting_FullMethodName   = "/users.UserService/MarkDeleting"
	UserService_FinalizeDelete_FullMethodName = "/users.UserService/FinalizeDelete"
	UserService_RestoreUser_FullMethodName    = "/users.UserService/RestoreUser"
)
...
type UserServiceClient interface {
	...
	MarkDeleting(ctx context.Context, in *MarkDeletingRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	FinalizeDelete(ctx context.Context, in *FinalizeDeleteRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	RestoreUser(ctx context.Context, in *RestoreUserRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *userServiceClient) MarkDeleting(ctx context.Context, in *MarkDeletingRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, UserService_MarkDeleting_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) FinalizeDelete(ctx context.Context, in *FinalizeDeleteRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, UserService_FinalizeDelete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) RestoreUser(ctx context.Context, in *RestoreUserRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type UserServiceServer interface {
	...
	MarkDeleting(context.Context, *MarkDeletingRequest) (*emptypb.Empty, error)
	FinalizeDelete(context.Context, *FinalizeDeleteRequest) (*emptypb.Empty, error)
	RestoreUser(context.Context, *RestoreUserRequest) (*emptypb.Empty, error)
...
func (UnimplementedUserServiceServer) MarkDeleting(context.Context, *MarkDeletingRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method MarkDeleting not implemented")
}
func (UnimplementedUserServiceServer) FinalizeDelete(context.Context, *FinalizeDeleteRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method FinalizeDelete not implemented")
}
func (UnimplementedUserServiceServer) RestoreUser(context.Context, *RestoreUserRequest) (*emptypb.Empty, error) {
...
func _UserService_MarkDeleting_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MarkDeletingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).MarkDeleting(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_MarkDeleting_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).MarkDeleting(ctx, req.(*MarkDeletingRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _UserService_FinalizeDelete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FinalizeDeleteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).FinalizeDelete(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_FinalizeDelete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).FinalizeDelete(ctx, req.(*FinalizeDeleteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "MarkDeleting",
			Handler:    _UserService_MarkDeleting_Handler,
		},
		{
			MethodName: "FinalizeDelete",
			Handler:    _UserService_FinalizeDelete_Handler,
		},
		{
